/**
 * @dsh-external/dsh-git-panel — server 半（dsh web 插件，cordis patch 层挂载）。
 *
 * 只读 git 工作区快照 RPC：
 ...
 *
 * @module @dsh-external/dsh-git-panel/entry
 */
...
export const RPC_PREFIX = '/dsh-git-panel/api'
...
/** 路径尾段即 method（/dsh-git-panel/api/snapshot → 'snapshot'）。 */
